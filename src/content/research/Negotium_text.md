...
### Version 1: People Forgot

We started with internal testing using team members. Each person completed one learning module daily and filled out two forms: an After-Session feedback form and an End-Of-Day form.

Almost everyone forgot the After-Session form and only remembered the EOD form when I sent daily reminder emails. This taught us a crucial lesson: **how might we capture feedback while minimizing the burden on users?**

### Version 2: Refined and Launched

I combined both forms into one, revised questions to focus on daily-appropriate feedback, and created a built-in button for easy access. The final study spanned one week with 5 participants recruited through social media, each attending a 30-minute onboarding session, submitting daily feedback whether they used the app or not, and completing a 45-minute debrief interview.
...
[📎 Insert findings overview image here]
